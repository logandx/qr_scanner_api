...
/// from: com.example.qr_scanner_api.Scanner
class Scanner extends jni.JObject {
  @override
  late final jni.JObjType<Scanner> $type = type;

  Scanner.fromReference(
    jni.JReference reference,
  ) : super.fromReference(reference);

  static final _class =
      jni.JClass.forName(r"com/example/qr_scanner_api/Scanner");
  ...
  factory Scanner() {
    return Scanner.fromReference(
        _new0(_class.reference.pointer, _id_new0 as jni.JMethodIDPtr)
            .reference);
  }

  static final _id_await0 = _class.instanceMethodId(
    r"await",
    r"(Lcom/google/android/gms/tasks/Task;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;",
  );

  static final _await0 = ProtectedJniExtensions.lookup<
          ffi.NativeFunction<
              jni.JniResult Function(
                  ffi.Pointer<ffi.Void>,
                  jni.JMethodIDPtr,
  ...
  Future<$T> await0<$T extends jni.JObject>(
    ...
    _await0(reference.pointer, _id_await0 as jni.JMethodIDPtr,
            task.reference.pointer, $c.reference.pointer)
...
final class $ScannerType extends jni.JObjType<Scanner> {
  const $ScannerType();

  @override
  String get signature => r"Lcom/example/qr_scanner_api/Scanner;";

  @override
  Scanner fromReference(jni.JReference reference) =>
      Scanner.fromReference(reference);
...
class GmsBarcodeScanning extends jni.JObject {
  ...
  GmsBarcodeScanning.fromReference(
    jni.JReference reference,
  ) : super.fromReference(reference);

  static final _class = jni.JClass.forName(
      r"com/google/mlkit/vision/codescanner/GmsBarcodeScanning");

  /// The type which includes information such as the signature of this class.
  static const type = $GmsBarcodeScanningType();
  static final _id_getClient = _class.staticMethodId(
    r"getClient",
    r"(Landroid/content/Context;)Lcom/google/mlkit/vision/codescanner/GmsBarcodeScanner;",
  );
  ...
  static GmsBarcodeScanner getClient(
    ...
    return _getClient(_class.reference.pointer,
            _id_getClient as jni.JMethodIDPtr, context.reference.pointer)
        .object(const $GmsBarcodeScannerType());
  }

  static final _id_getClient1 = _class.staticMethodId(
    r"getClient",
    r"(Landroid/content/Context;Lcom/google/mlkit/vision/codescanner/GmsBarcodeScannerOptions;)Lcom/google/mlkit/vision/codescanner/GmsBarcodeScanner;",
  );
  ...
  static GmsBarcodeScanner getClient1(
    ...
    return _getClient1(
            ...
            gmsBarcodeScannerOptions.reference.pointer)
        .object(const $GmsBarcodeScannerType());
  }
}

final class $GmsBarcodeScanningType extends jni.JObjType<GmsBarcodeScanning> {
  ...
  @override
  GmsBarcodeScanning fromReference(jni.JReference reference) =>
      GmsBarcodeScanning.fromReference(reference);
...
class GmsBarcodeScanner extends jni.JObject {
  ...
  GmsBarcodeScanner.fromReference(
    jni.JReference reference,
  ) : super.fromReference(reference);

  static final _class = jni.JClass.forName(
      r"com/google/mlkit/vision/codescanner/GmsBarcodeScanner");
  ...
  static final _startScan = ProtectedJniExtensions.lookup<
          ffi.NativeFunction<
              jni.JniResult Function(
                ffi.Pointer<ffi.Void>,
                jni.JMethodIDPtr,
  ...
  Task<Barcode> startScan() {
    return _startScan(reference.pointer, _id_startScan as jni.JMethodIDPtr)
        .object(const $TaskType($BarcodeType()));
  }
}

final class $GmsBarcodeScannerType extends jni.JObjType<GmsBarcodeScanner> {
  ...
  @override
  GmsBarcodeScanner fromReference(jni.JReference reference) =>
      GmsBarcodeScanner.fromReference(reference);
...
class BarcodeSource extends jni.JObject {
  ...
  BarcodeSource.fromReference(
    jni.JReference reference,
  ) : super.fromReference(reference);

  static final _class = jni.JClass.forName(
      r"com/google/mlkit/vision/barcode/common/internal/BarcodeSource");
...
final class $BarcodeSourceType extends jni.JObjType<BarcodeSource> {
  ...
  @override
  BarcodeSource fromReference(jni.JReference reference) =>
      BarcodeSource.fromReference(reference);
